            ...
            <div className="container mx-auto">
                <div className="flex items-center justify-between relative">
                    ...
                    <div className="flex items-center px-4">
                        ...
                        <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="lg:hidden block absolute right-4">
                        ...
                        {/* Menu Navigasi */}
                        <nav className={`${isMenuOpen ? 'block' : 'hidden'} lg:block absolute lg:static bg-white lg:bg-transparent shadow-lg lg:shadow-none rounded-lg max-w-[250px] w-full right-4 top-full lg:max-w-full lg:w-auto`}>
                            <ul className="block lg:flex text-[17px]">
                                <li className="group">
                                    <Link href="/#Home" className="text-black py-2 mx-5 flex font-semibold group-hover:text-orange-600">
                                        Home
                                    </Link>
                                </li>
                                <li className="group">
                    ...
                    {/* Tombol Aksi (hanya muncul di desktop) */}
