        ...
        <footer className="bg-gray-600">
            <div className="container mx-auto">
                <div className="flex flex-col items-center py-10">
                    ...
                    <svg fill="#ffffff" height="28px" strokeWidth="1px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="-271 273 256 256" stroke="#ffffff"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier" className="size-5 fill-gray-400 hover:fill-white transition-colors"> 
